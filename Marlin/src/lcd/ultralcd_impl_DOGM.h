...
// LCD selection
  ...
  // Generic support for SSD1306 OLED I2C LCDs
    ...
    U8GLIB_SSD1306_128X64_2X u8g(DOGLCD_SCK, DOGLCD_MOSI, DOGLCD_CS, DOGLCD_A0, LCD_RESET); // 4 stripes
  #else
    // U8GLIB_SSD1306_128X64_2X_I2C_2_WIRE  u8g(U8G_I2C_OPT_NONE); // 4 stripes
    // U8GLIB_SSD1306_128X64_2X_I2C_2_WIRE  u8g(U8G_I2C_OPT_NONE | U8G_I2C_OPT_FAST); // 4 stripes
    // U8GLIB_SSD1306_128X64_2X u8g(U8G_I2C_OPT_DEV_0); // 4 stripes
    U8GLIB_SSD1306_128X64_2X u8g(U8G_I2C_OPT_DEV_0 | U8G_I2C_OPT_NO_ACK | U8G_I2C_OPT_FAST); // 4 stripes
    // U8GLIB_SSD1306_128X64 u8g(U8G_I2C_OPT_DEV_0 | U8G_I2C_OPT_NO_ACK | U8G_I2C_OPT_FAST); // 4 stripes
    // U8GLIB_SSD1306_128X64_2X u8g(U8G_I2C_OPT_DEV_0 | U8G_I2C_OPT_FAST); // 4 stripes
    // U8GLIB_SSD1306_128X64 u8g(U8G_I2C_OPT_DEV_1|U8G_I2C_OPT_NO_ACK|U8G_I2C_OPT_FAST); 
  #endif
